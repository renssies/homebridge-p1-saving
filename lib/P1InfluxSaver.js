...
function dataPointForElectricity(electricity, measurement) {
  console.log("Type of elect consumption.normal:")
  console.log(typeof electricity.consumption.normal)
...
function dataPointForGas(gas, measurement) {
  console.log("Type of gas consumption:")
  console.log(typeof gas.consumption)
  return {
    measurement: measurement,
    fields: {
...
function dataPointForPhase(phase, name) {
  console.log("Type of phase power:")
  console.log(typeof phase.power)
  return {
    measurement: "electricity_phase",
    fields: {
      power: phase.power || 0,
