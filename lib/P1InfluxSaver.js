...
const Schema = [
  {
    ...
    fields: {
      total_power: Influx.FieldType.DOUBLE,
      total: Influx.FieldType.DOUBLE,
      total_normal: Influx.FieldType.DOUBLE,
      total_low: Influx.FieldType.DOUBLE
    }
  },
  {
  ...
  },
  {
    ...
    fields: {
      power: Influx.FieldType.DOUBLE,
      current: Influx.FieldType.DOUBLE,
      voltage: Influx.FieldType.DOUBLE
    },
...
function dataPointForElectricity(electricity, measurement) {
  return {
    ...
    timestamp: electricity.lastupdated
  }
}
...
function dataPointForPhase(phase, phname) {
  return {
    measurement: "electricity_phase",
    fields: {
      power: phase.power || 0,
      total: phase.current || 0,
