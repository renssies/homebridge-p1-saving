...
function dataPointForElectricity(electricity, measurement) {
  this.log.info("Type of elect consumption.normal:")
  this.log.info(typeof electricity.consumption.normal)
...
function dataPointForGas(gas, measurement) {
  this.log.info("Type of gas consumption:")
  this.log.info(typeof gas.consumption)
  return {
    measurement: measurement,
    fields: {
...
function dataPointForPhase(phase, name) {
  this.log.info("Type of phase power:")
  this.log.info(typeof phase.power)
  return {
    measurement: "electricity_phase",
    fields: {
      power: phase.power || 0,
